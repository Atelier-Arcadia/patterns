...
describe("Tool Handlers", () => {
  ...
  describe("discover", () => {
    ...
    it("returns each category with name, slug, and description", async () => {
      ...
      expect(widgets.description).toBe("Spells for widget creation");
    });
  ...
  describe("match", () => {
    it("returns spells for valid domain and categories", async () => {
    ...
    it("returns spells from multiple categories", async () => {
      const result = await matchHandler({
        domain: "test-domain",
    ...
    it("includes full spell data in results", async () => {
      const result = await matchHandler({
        domain: "test-domain",
        categories: ["gadgets"],
      });
  ...
  describe("suggest", () => {
    it("creates a 'new' spell suggestion with source", async () => {
      const result = await suggestHandler({
        type: "new",
        domainSlug: "test-domain",
        categorySlug: "widgets",
        label: "suggested-widget",
        description: "A suggested widget spell",
    ...
    it("creates a 'modify' spell suggestion with source", async () => {
      ...
      const result = await suggestHandler({
        ...
        description: "An improved widget spell",
